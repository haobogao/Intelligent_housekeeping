...
#define SAMPLEAPP_UART_CLUSTERID 3
  
  //温湿度数据标记
#define SAMPLEAPP_TEMP_CLUSTERID 4
...
/*********************************************************************
*********************************************************************/
extern void Coor_sendtonode( uint8 *buf, uint16 len );
extern void Receive_From_Uart(unsigned char port, unsigned char event); 
